    ...
    <div className='bg-white text-black'>
      ...
      <section className='relative overflow-hidden'>
        <div className='absolute inset-0'>
          <img
            src={product.image}
            alt='Endobronchial Blocker Tube (Without Auto-inflation)'
        ...
        <div className='relative max-w-6xl mx-auto px-6 py-24 lg:py-32'>
          <div className='lg:w-2/3'>
            ...
            <h1 className='text-4xl lg:text-6xl font-extrabold mt-4 mb-6'>
              Endobronchial Blocker Tube (Without Auto-inflation)
            </h1>
            <p className='text-lg lg:text-xl text-black mb-8'>
              Endobronchial Blocker Tube allows one-lung ventilation by using a conventional endotracheal tube and a fiberoptic bronchoscope.
            </p>
        ...
        <div className='mt-12'>
          ...
          <div className='overflow-x-auto'>
            <table className='w-full border-collapse'>
              ...
              <tbody>
                <tr>
                  <td className='border border-gray-300 px-6 py-4 text-black'>5Fr</td>
                  <td className='border border-gray-300 px-6 py-4 text-black'>EBT0105</td>
                </tr>
                <tr className='bg-gray-50'>
                  <td className='border border-gray-300 px-6 py-4 text-black'>7Fr</td>
                  <td className='border border-gray-300 px-6 py-4 text-black'>EBT0107</td>
                </tr>
                <tr>
                  <td className='border border-gray-300 px-6 py-4 text-black'>9Fr</td>
                  <td className='border border-gray-300 px-6 py-4 text-black'>EBT0109</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className='bg-primary/10 border border-primary/30 rounded-3xl px-10 py-12 flex flex-col lg:flex-row items-center lg:items-start gap-8'>
          <div className='lg:w-2/3 space-y-4'>
            ...
            <p className='text-black'>
              Contact our specialists to discuss how Endobronchial Blocker Tube can enhance your airway management protocols.
            </p>
          </div>
          <a 
            href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product.name} ($${product.price})`}
