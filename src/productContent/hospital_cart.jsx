        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[520px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/editor/screenshot-963.png?1490147176'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-xl text-gray-600 leading-relaxed mb-8'>
              Medication, emergency, and injection carts (C3512/C3300/C3100/C3000/C3600/C3500) with mixed polymer, aluminum, and steel construction for durability and mobility.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Medication cart with 12 large bins.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Emergency cart options in polymer or mixed materials.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Injection cart configuration for versatile clinical use.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Polymer/aluminum/steel construction for strength and weight balance.</span></li>
          </ul>
        </div>
      </section>
