        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[520px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/editor/t4.jpg?1490170765'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-xl text-gray-600 leading-relaxed mb-8'>
              Utility, CSSD, and janitor room furniture including wall racks, bedpan holders, baskets, linen racks, carts, and storage cabinets for sterile workflows.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Wall racks, bedpan holders, CSSD racks and baskets.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Surgical soiled linen racks and laundry carts.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Paper stands and stainless/ glass storage cabinets.</span></li>
          </ul>
        </div>
      </section>
