...
function MemoryPillarShapedPadsPage({ product }) {
  ...
  const description = `The Memory Pillar Shaped Pads are specialized positioning devices featuring memory foam construction and a cylindrical, pillar-shaped design designed to provide support and pressure relief during surgical procedures. These pads provide superior comfort through their memory foam material.
...
The Memory Pillar Shaped Pads provide healthcare professionals with superior comfort and versatile positioning support, ensuring patient comfort and preventing pressure injuries during surgical procedures.`
