        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-6 text-black'>
              Elbow Protectors (2102)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Elbow protectors designed to cushion and protect the elbow, helping to avoid ulnar nerve injury
              during procedures.
            </p>
          ...
          <div className='space-y-4 text-gray-700'>
            ...
            <div className='space-y-3'>
              <div className='flex items-start gap-3'>
                ...
                <p>Protect elbow and avoid ulnar nerve injury.</p>
              </div>
            </div>
