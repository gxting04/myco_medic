    ...
    <div className='bg-white text-black'>
      ...
      <section className='relative overflow-hidden'>
        <div className='absolute inset-0'>
          <img
            src={product.image}
            alt='Silicone Double Lumen Endobronchial Tube'
        ...
        <div className='relative max-w-6xl mx-auto px-6 py-24 lg:py-32'>
          <div className='lg:w-2/3'>
            ...
            <h1 className='text-4xl lg:text-6xl font-extrabold mt-4 mb-6'>
              Silicone Double Lumen Endobronchial Tube
            </h1>
        ...
        <div className='grid md:grid-cols-2 gap-12 items-center mb-16'>
          <div className='space-y-6'>
            ...
            <div className='flex gap-4'>
              <div className='flex-shrink-0 w-2 h-2 mt-2 rounded-full bg-primary'></div>
              <p className='text-lg text-black'>
                Steel reinforced top can prevent kinking and movement, convenient for radiography location.
              </p>
            </div>
            <div className='flex gap-4'>
              <div className='flex-shrink-0 w-2 h-2 mt-2 rounded-full bg-primary'></div>
            ...
            <table className='w-full border-collapse'>
              ...
              <tbody>
                <tr>
                  ...
                  <td className='border border-gray-300 px-6 py-4 text-black'>DLT0132S</td>
                </tr>
                <tr className='bg-gray-50'>
                  <td className='border border-gray-300 px-6 py-4 text-black'>35Fr</td>
                  <td className='border border-gray-300 px-6 py-4 text-black'>DLT0135S</td>
                </tr>
                <tr>
                  <td className='border border-gray-300 px-6 py-4 text-black'>37Fr</td>
                  <td className='border border-gray-300 px-6 py-4 text-black'>DLT0137S</td>
                </tr>
                <tr className='bg-gray-50'>
                  <td className='border border-gray-300 px-6 py-4 text-black'>39Fr</td>
                  <td className='border border-gray-300 px-6 py-4 text-black'>DLT0139S</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className='bg-primary/10 border border-primary/30 rounded-3xl px-10 py-12 flex flex-col lg:flex-row items-center lg:items-start gap-8'>
          <div className='lg:w-2/3 space-y-4'>
            ...
            <p className='text-black'>
              Contact our specialists to discuss how Silicone Double Lumen Endobronchial Tube can enhance your airway management protocols.
            </p>
          </div>
          <a 
            href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product.name} ($${product.price})`}
