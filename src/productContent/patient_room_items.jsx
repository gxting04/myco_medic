        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[520px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/published/10_2.png?1490164204'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-xl text-gray-600 leading-relaxed mb-8'>
              Patient room essentials: ABS lockers, over-bed tables, mattresses, IV stands, ward screens, bins, pans, and lighting to outfit wards efficiently.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>ABS lockers, bedside racks, over-bed tables (standard & fingertip adjustable).</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Mattresses: Chemsafe, air/ripple, and Transcell options.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>IV stands (standard and electric), ward screens, and surgical bins.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Lighting, injection trays, sack holders, and surgical stand bowls.</span></li>
          </ul>
        </div>
      </section>
