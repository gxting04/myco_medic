        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[420px] bg-white flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/published/image-4.png?1671607201'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-lg md:text-xl text-gray-600 leading-relaxed mb-8'>
              Full-face protective shield for adults and children. Anti-fog inner/outer surfaces, soft foam headband, lightweight, and quick to wear; size 330 x 220mm.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Full facial protection from fluid and chemical splatter.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Anti-fog treatment on both sides of the shield.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Soft foam headband for comfort; lightweight for extended wear.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Fast and easy to wear; suitable for hospitals, labs, education, factories, public places.</span></li>
          </ul>
        </div>
      </section>
