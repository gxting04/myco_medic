        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-6 text-black'>
              Hip Pads (3104 Series)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Hip pads designed to protect the sacrum area from pressure sores during surgery and prolonged
              positioning.
            </p>
            <div className='flex flex-wrap gap-4 mt-8'>
              <a
                href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product?.name ?? 'Hip Pads'}`}
          ...
          <div className='space-y-4 text-gray-700'>
            ...
            <div className='space-y-3'>
              <div className='flex items-start gap-3'>
                ...
                <p>To protect sacrum area from pressure sores.</p>
              </div>
            </div>
