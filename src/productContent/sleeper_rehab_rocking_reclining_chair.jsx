        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[520px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/screenshot-989_2_orig.png'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-xl text-gray-600 leading-relaxed mb-8'>
              Collection of chairs and stools for clinical and patient use: recliners, sleeper/company chairs, rotating/ENT/surgeon stools, blood-taking chairs, patient link chairs, geriatric chairs, and visitor seating.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Reclining/rocking chairs (CHR series) for patient and attendant comfort.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Sleeper/company chairs and patient link chairs for wards and waiting.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Doctor/ENT/surgeon stools (CHS series) with foot or pneumatic control.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Blood-taking chairs (CHBT series) and visitor chairs for outpatient areas.</span></li>
          </ul>
        </div>
      </section>
