    ...
    <div className='bg-white text-black'>
      ...
      <section className='relative overflow-hidden'>
        <div className='absolute inset-0'>
          <img
            src={product.image}
            alt='PVC Wire Reinforced Endotracheal Tube'
        ...
        <div className='relative max-w-6xl mx-auto px-6 py-24 lg:py-32'>
          <div className='lg:w-2/3'>
            ...
            <h1 className='text-4xl lg:text-6xl font-extrabold mt-4 mb-6'>
              PVC Wire Reinforced Endotracheal Tube (Cuffed & Uncuffed)
            </h1>
            <p className='text-lg lg:text-xl text-black mb-8'>
              Medical PVC, DEHP free.
            </p>
        ...
        <div className='mt-16'>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-start mb-16'>
            <div className='rounded-2xl overflow-hidden shadow-xl'>
              <img
                src={product.image}
                alt='PVC Wire Reinforced Endotracheal Tube - Cuffed'
                className='w-full h-auto object-cover'
              />
            </div>
              ...
              <table className='w-full border-collapse'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT3014C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>3.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT3514C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4014C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4514C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5014C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5514C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6014C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6514C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>7.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT7014C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>7.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT7514C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>8.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT8014C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>8.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT8514C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>9.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT9014C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>9.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT9514C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>10.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT10014C</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className='mt-16'>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-start'>
            <div className='rounded-2xl overflow-hidden shadow-xl'>
              <img
                src={product.image}
                alt='PVC Wire Reinforced Endotracheal Tube - Uncuffed'
                className='w-full h-auto object-cover'
              />
            </div>
            <div className='overflow-x-auto'>
              <table className='w-full border-collapse'>
                ...
                <tbody>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>3.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT3014</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>3.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT3514</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4014</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4514</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5014</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5514</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6014</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6514</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>7.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT7014</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>7.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT7514</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>8.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT8014</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>8.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT8514</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>9.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT9014</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className='bg-primary/10 border border-primary/30 rounded-3xl px-10 py-12 flex flex-col lg:flex-row items-center lg:items-start gap-8'>
          <div className='lg:w-2/3 space-y-4'>
            ...
            <p className='text-black'>
              Contact our specialists to discuss how PVC Wire Reinforced Endotracheal Tube can enhance your airway management protocols.
            </p>
          </div>
          <a 
            href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product.name} ($${product.price})`}
