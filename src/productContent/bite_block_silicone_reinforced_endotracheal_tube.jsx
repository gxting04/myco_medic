    ...
    <div className='bg-white text-black'>
      ...
      <section className='relative overflow-hidden'>
        <div className='absolute inset-0'>
          <img
            src={product.image}
            alt='Bite Block Silicone Reinforced Endotracheal Tube'
        ...
        <div className='relative max-w-6xl mx-auto px-6 py-24 lg:py-32'>
          <div className='lg:w-2/3'>
            ...
            <h1 className='text-4xl lg:text-6xl font-extrabold mt-4 mb-6'>
              Bite Block Silicone Reinforced Endotracheal Tube (Cuffed & Uncuffed)
            </h1>
        ...
        <div className='mt-16'>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-start mb-16'>
            <div className='rounded-2xl overflow-hidden shadow-xl'>
              <img
                src={product.image}
                alt='Bite Block Silicone Reinforced Endotracheal Tube - Cuffed'
                className='w-full h-auto object-cover'
              />
            </div>
              ...
              <table className='w-full border-collapse'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT3525C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4025C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4525C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5025C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5525C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6025C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6525C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>7.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT7025C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>7.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT7525C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>8.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT8025C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>8.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT8525C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>9.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT9025C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>9.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT9525C</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className='mt-16'>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-start'>
            <div className='rounded-2xl overflow-hidden shadow-xl'>
              <img
                src={product.image}
                alt='Bite Block Silicone Reinforced Endotracheal Tube - Uncuffed'
                className='w-full h-auto object-cover'
              />
            </div>
            <div className='overflow-x-auto'>
              <table className='w-full border-collapse'>
                ...
                <tbody>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>3.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT3525</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4025</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4525</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5025</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5525</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6025</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6525</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>7.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT7025</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className='bg-primary/10 border border-primary/30 rounded-3xl px-10 py-12 flex flex-col lg:flex-row items-center lg:items-start gap-8'>
          <div className='lg:w-2/3 space-y-4'>
            ...
            <p className='text-black'>
              Contact our specialists to discuss how Bite Block Silicone Reinforced Endotracheal Tube can enhance your airway management protocols.
            </p>
          </div>
          <a 
            href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product.name} ($${product.price})`}
