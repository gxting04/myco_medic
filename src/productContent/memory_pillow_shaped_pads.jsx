...
function MemoryPillowShapedPadsPage({ product }) {
  ...
  const description = `The Memory Pillow Shaped Pads are specialized positioning devices featuring memory foam construction and a pillow-like design designed to provide comfortable support and pressure relief during surgical procedures. These pads provide superior comfort through their memory foam material.
...
• Patient comfort – memory foam provides pillow-like comfortable support
• Versatile application – suitable for various positioning needs
...
The Memory Pillow Shaped Pads provide healthcare professionals with superior comfort and pillow-like support, ensuring patient comfort and preventing pressure injuries during surgical procedures.`
