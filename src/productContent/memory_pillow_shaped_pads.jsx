...
// https://www.mycomedic.com.my/memory-pillow-shaped-pads.html
const SIZE_OPTIONS = [
  {
    code: 'OKL-M01',
    label: 'OKL-M01 – 300 mm x 230 mm x 60 mm',
    sizeText: '300 mm x 230 mm x 60 mm'
  },
  {
    code: 'OKL-M02',
    label: 'OKL-M02 – 280 mm x 200 mm x 40 mm',
    sizeText: '280 mm x 200 mm x 40 mm'
  },
  {
    code: 'OKL-M03',
    label: 'OKL-M03 – 380 mm x 250 mm x 100 mm',
    sizeText: '380 mm x 250 mm x 100 mm'
  }
]

function MemoryPillowShapedPadsPage({ product }) {
        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-4 text-black'>
              Memory Pillow Shaped Pads (OKL-M01 / OKL-M02 / OKL-M03)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Extremely versatile pillow-shaped positioners designed to eliminate the use of sandbags and provide stable
              support for a wide range of procedures.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <ul className='space-y-3 text-gray-700'>
                <li className='flex items-start gap-3'>
                  ...
                  <span>Eliminate use of sandbags with this extremely versatile positioner—good for many procedures.</span>
                </li>
                <li className='flex items-start gap-3'>
                  <svg className='w-6 h-6 text-primary mt-1' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                    <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M5 13l4 4L19 7' />
                  ...
                  <span>
                    Beneficial for tracheotomy, thyroidectomy, tonsil and adenoid cases, cataract or other ophthalmic
                    procedures.
                  </span>
                </li>
              </ul>
              ...
              <table className='w-full'>
                ...
                <tbody>
                  <tr className='bg-gray-50'>
                    <td className='px-6 py-4 font-medium text-gray-900'>OKL-M01</td>
                    <td className='px-6 py-4 text-gray-700'>300 mm x 230 mm x 60 mm</td>
                  </tr>
                  <tr className='bg-white'>
                    <td className='px-6 py-4 font-medium text-gray-900'>OKL-M02</td>
                    <td className='px-6 py-4 text-gray-700'>280 mm x 200 mm x 40 mm</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='px-6 py-4 font-medium text-gray-900'>OKL-M03</td>
                    <td className='px-6 py-4 text-gray-700'>380 mm x 250 mm x 100 mm</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
export default MemoryPillowShapedPadsPage
