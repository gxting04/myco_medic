      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Sterile pack supports a range of general procedures.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Single-use to minimize cross-infection risk.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Reduces setup and turnaround time in busy settings.</span></li>
          </ul>
        </div>
      </section>
