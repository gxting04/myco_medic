        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-16 mb-12 md:mb-16'>
            ...
            <div className='space-y-6 lg:pt-4'>
              ...
              {/* Shopee Purchase Box */}
              <a 
                href='https://shopee.com.my/product/66003822/4162701896/'
                target='_blank'
                rel='noopener noreferrer'
                className='block w-full bg-gradient-to-r from-[#EE4D2D] to-[#FF6B4A] text-white py-4 px-6 rounded-xl hover:from-[#FF6B4A] hover:to-[#EE4D2D] transition-all duration-200 font-semibold text-center shadow-lg hover:shadow-xl active:scale-[0.98] flex items-center justify-center gap-3 group'
              >
