        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[420px] bg-white flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/published/82677f05e0aca922100d2e993ca0a099.jpeg?1645172629'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-lg md:text-xl text-gray-600 leading-relaxed mb-8'>
              Non-sterile coverall jumpsuit (60gsm, white, unisex one-size) with breathable, waterproof, dust-proof, and antibacterial properties. Includes a pair of boot covers.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Material: Polypropylene + polyethylene film; 60gsm.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Features: Breathable, waterproof, dust-proof, antibacterial.</span></li>
            ...
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Includes 1 pair boot covers; single piece per pack.</span></li>
