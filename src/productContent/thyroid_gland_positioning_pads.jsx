        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-6 text-black'>
              Thyroid Gland Positioning Pads (1110)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Neck positioning pads designed to support and protect the neck in thyroid and cervical procedures,
              while helping to fully extend the operative field for surgeons.
            </p>
            <div className='flex flex-wrap gap-4 mt-8'>
              <a
                href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product?.name ?? 'Thyroid Gland Positioning Pads'}`}
      ...
      <section className='max-w-6xl mx-auto px-6 py-16'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-start'>
          <div>
            <img
              src={product?.image}
              alt='Thyroid Gland Positioning Pads'
          ...
          <div className='space-y-4 text-gray-700'>
            ...
            <div className='space-y-3'>
              <div className='flex items-start gap-3'>
                ...
                <p>Designed to protect and support the neck in thyroid and neck surgery.</p>
              </div>
              <div className='flex items-start gap-3'>
                <svg className='w-6 h-6 text-primary mt-1' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M5 13l4 4L19 7' />
                </svg>
                <p>Helps fully extend the operative field for better surgical visualization.</p>
              </div>
            </div>

            <div className='mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg text-gray-800'>
              <h3 className='text-xl font-bold mb-2 text-black'>Usage note</h3>
              <p>
                It is suggested that model 1101-1 (from the prostrate head pads series) be used together with
                1110-2 for optimal neck positioning support.
              </p>
            </div>
          </div>
        </div>
