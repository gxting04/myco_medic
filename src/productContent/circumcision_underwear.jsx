        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[420px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/whatsapp-image-2024-01-26-at-11-36-07-am-removebg-preview_orig.png'
              }}
            />
          </div>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Sizes: XS, S, M, L, XL, XXL, XXXL.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Colors supplied randomly.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Designed for comfort after circumcision procedures.</span></li>
          </ul>
        </div>
      </section>
