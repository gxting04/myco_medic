        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-6 text-black'>
              Pillar Shaped Pads (3109)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Multi-purpose pillar-shaped pads that offer positioning, protection and support for the ankle, knee,
              shoulder, chest and hipbone across re-supine, prone and lateral procedures.
            </p>
            <div className='flex flex-wrap gap-4 mt-8'>
              <a
                href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product?.name ?? 'Pillar Shaped Pads'}`}
          ...
          <div className='space-y-4 text-gray-700'>
            ...
            <div className='space-y-3'>
              <div className='flex items-start gap-3'>
                ...
                <p>Provide positioning, protection and support for ankle, knee and shoulder in re-supine surgeries.</p>
              </div>
              <div className='flex items-start gap-3'>
                <svg className='w-6 h-6 text-primary mt-1' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M5 13l4 4L19 7' />
                ...
                <p>
                  Can be used to protect and support shoulder, chest and hipbone in prostrate surgeries, and to
                  protect the armpit in lateral surgeries.
                </p>
              </div>
            </div>
            ...
            <div className='mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg text-gray-800'>
              ...
              <p>Available in multiple pillar-shaped configurations, as shown in the original 3109 series.</p>
            </div>
          </div>
        </div>
      </section>
