        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[420px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/editor/image-7.png?1645177828'
              }}
            />
          </div>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Material: 100% LDPE polyethylene; 0.03mm thickness.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Size: one size (70x115cm); color: blue.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Water-repellent, anti-dust, lightweight.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Packaging: 100 pieces per pack; single-use.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Applications: healthcare, hygiene, food handling, cleaning, housekeeping.</span></li>
          </ul>
        </div>
      </section>
