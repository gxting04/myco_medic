        ...
        <div className='mt-12'>
          ...
          <div className='overflow-x-auto'>
            <table className='w-full border-collapse'>
              ...
              <tbody>
                <tr>
                  <td className='border border-gray-300 px-6 py-4 text-black'>3.0cm</td>
                </tr>
                <tr className='bg-gray-50'>
                  <td className='border border-gray-300 px-6 py-4 text-black'>3.5cm</td>
                </tr>
                <tr>
                  <td className='border border-gray-300 px-6 py-4 text-black'>4.0cm</td>
                </tr>
                <tr className='bg-gray-50'>
                  <td className='border border-gray-300 px-6 py-4 text-black'>4.5cm</td>
                </tr>
                <tr>
                  <td className='border border-gray-300 px-6 py-4 text-black'>5.0cm</td>
                </tr>
                <tr className='bg-gray-50'>
                  <td className='border border-gray-300 px-6 py-4 text-black'>5.5cm</td>
                </tr>
                <tr>
                  <td className='border border-gray-300 px-6 py-4 text-black'>6.0cm</td>
                </tr>
                <tr className='bg-gray-50'>
                  <td className='border border-gray-300 px-6 py-4 text-black'>6.5cm</td>
                </tr>
                <tr>
                  <td className='border border-gray-300 px-6 py-4 text-black'>7.0cm</td>
                </tr>
                <tr className='bg-gray-50'>
                  <td className='border border-gray-300 px-6 py-4 text-black'>8.0cm</td>
                </tr>
                <tr>
                  <td className='border border-gray-300 px-6 py-4 text-black'>9.0cm</td>
                </tr>
                <tr className='bg-gray-50'>
                  <td className='border border-gray-300 px-6 py-4 text-black'>10.0cm</td>
                </tr>
                <tr>
                  <td className='border border-gray-300 px-6 py-4 text-black'>11.0cm</td>
                </tr>
                <tr className='bg-gray-50'>
                  <td className='border border-gray-300 px-6 py-4 text-black'>12.0cm</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className='bg-primary/10 border border-primary/30 rounded-3xl px-10 py-12 flex flex-col lg:flex-row items-center lg:items-start gap-8'>
          <div className='lg:w-2/3 space-y-4'>
            ...
            <p className='text-black'>
              Contact our specialists to discuss how Oropharyngeal Airway can enhance your airway management protocols.
            </p>
          </div>
          <a 
            href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product.name} ($${product.price})`}
