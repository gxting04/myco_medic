        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-6 text-black'>
              Universal Armboard Pads (2101)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Universal armboard pads applicable to standard arm accessory stands, helping to protect the
              patient&apos;s biceps, elbows and forearms during procedures.
            </p>
            <div className='flex flex-wrap gap-4 mt-8'>
              <a
                href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product?.name ?? 'Universal Armboard Pads'}`}
          ...
          <div className='space-y-4 text-gray-700'>
            ...
            <div className='space-y-3'>
              <div className='flex items-start gap-3'>
                ...
                <p>Applicable to standard arm accessory stands.</p>
              </div>
              <div className='flex items-start gap-3'>
                <svg className='w-6 h-6 text-primary mt-1' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M5 13l4 4L19 7' />
                </svg>
                <p>Offers protection to the patient&apos;s biceps, elbows and forearms.</p>
              </div>
            </div>
