        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-6 text-black'>
              Wrist Protectors (2103)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Wrist protectors designed to fix and cushion the wrist, helping to prevent nerve injury during
              positioning.
            </p>
            <div className='flex flex-wrap gap-4 mt-8'>
              <a
                href={`https://wa.me/60123822001?text=Hi, I'm interested in ${product?.name ?? 'Wrist Protectors'}`}
          ...
          <div className='space-y-4 text-gray-700'>
            ...
            <div className='space-y-3'>
              <div className='flex items-start gap-3'>
                ...
                <p>Fix and protect the wrist, avoiding nerve injury.</p>
              </div>
            </div>
            ...
            <div className='mt-8 bg-blue-50 border border-blue-200 rounded-lg text-gray-800'>
              ...
              <p>Available in different models and sizes, matching the Wrist Protectors 2103 series.</p>
            </div>
          </div>
        </div>
      </section>
