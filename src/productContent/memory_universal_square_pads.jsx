...
// https://www.mycomedic.com.my/memory-universal-square-pads.html
const SIZE_OPTIONS = [
  {
    code: 'OKL-F01',
    label: 'OKL-F01 – 500 mm x 400 mm x 20 mm',
    sizeText: '500 mm x 400 mm x 20 mm',
    useText: 'To protect sacrum area from pressure sores.'
  },
  {
    code: 'OKL-F02',
    label: 'OKL-F02 – 440 mm x 260 mm x 50 mm',
    sizeText: '440 mm x 260 mm x 50 mm',
    useText: 'To elevate any parts of the body in surgeries.'
  }
]

function MemoryUniversalSquarePadsPage({ product }) {
        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            <span className='text-primary uppercase tracking-widest text-sm font-semibold'>
              Memory Foam Positioners / Memory Universal Positioners
            </span>
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-4 text-black'>
              Memory Universal Square Pads (OKL-F01 / OKL-F02)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Flat, universal memory foam pads designed to protect vulnerable areas such as the sacrum from pressure
              sores and to elevate different parts of the body during surgery for better positioning and pressure
              redistribution.
            </p>
          </div>
        </div>
            ...
            <div>
              ...
              <ul className='space-y-3 text-gray-700'>
                <li className='flex items-start gap-3'>
                  ...
                  <span>Used under the sacrum or other pressure-prone areas to reduce the risk of pressure sores.</span>
                </li>
                <li className='flex items-start gap-3'>
                  <svg className='w-6 h-6 text-primary mt-1' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                    <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M5 13l4 4L19 7' />
                  ...
                  <span>
                    Can be placed beneath limbs or other body regions to provide elevation and more ergonomic positioning
                    during surgery.
                  </span>
                </li>
                <li className='flex items-start gap-3'>
                  ...
                  <span>Helps distribute pressure more evenly over a wide contact surface.</span>
                </li>
              </ul>
            </div>
                ...
                {SIZE_OPTIONS.map((option) => (
                  ...
                  >
                    <div>
                      ...
                      <div className='text-xs text-gray-600 mt-1'>{option.useText}</div>
                    </div>
                    {selectedSize.code === option.code && (
              ...
              <table className='w-full'>
                ...
                <tbody>
                  <tr className='bg-gray-50'>
                    <td className='px-6 py-4 font-medium text-gray-900'>OKL-F01</td>
                    <td className='px-6 py-4 text-gray-700'>500 mm x 400 mm x 20 mm</td>
                    <td className='px-6 py-4 text-gray-700'>
                      Designed to protect the sacrum area from pressure sores by providing a broad, low-profile support
                      surface.
                    </td>
                  </tr>
                  <tr className='bg-white'>
                    <td className='px-6 py-4 font-medium text-gray-900'>OKL-F02</td>
                    <td className='px-6 py-4 text-gray-700'>440 mm x 260 mm x 50 mm</td>
                    <td className='px-6 py-4 text-gray-700'>
                      Thicker pad used to elevate different body parts during surgeries for improved access and
                      offloading.
                    </td>
                  </tr>
                </tbody>
...
export default MemoryUniversalSquarePadsPage
