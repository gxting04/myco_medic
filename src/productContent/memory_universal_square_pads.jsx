...
function MemoryUniversalSquarePadsPage({ product }) {
  ...
  const description = `The Memory Universal Square Pads are versatile positioning devices featuring memory foam construction and a square design suitable for various positioning needs during surgical procedures. These pads provide superior comfort and pressure relief through their memory foam material.
...
The Memory Universal Square Pads provide healthcare professionals with superior comfort and versatile positioning support, ensuring patient comfort and preventing pressure injuries during surgical procedures.`
