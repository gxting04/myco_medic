        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[500px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/untitled_3_orig.png'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-xl text-gray-600 leading-relaxed mb-8'>
              Tracheal tube brushes crafted for effective cleaning of tracheal and airway tubes. Helps maintain patency and hygiene with appropriate bristle stiffness.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Sized for tracheal and airway tube cleaning.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Bristles designed to remove residue without damaging tubing.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Supports equipment hygiene between uses.</span></li>
          </ul>
        </div>
      </section>
