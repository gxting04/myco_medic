        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[520px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/published/screenshot-996.png?1643274044'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-xl text-gray-600 leading-relaxed mb-8'>
              Examination couches and tables (standard, luxury, gynae) for clinical rooms, offering patient comfort and clinician access.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Examination couch E3001 and standard tables E1002.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Luxury examination table E2003 for premium rooms.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Gynae-focused tables E5000 and E5002.</span></li>
          </ul>
        </div>
      </section>
