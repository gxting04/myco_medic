        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[520px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/published/screenshot-970.png?1724999909'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-xl text-gray-600 leading-relaxed mb-8'>
              Range of hospital trolleys and stands (T-series, LTS/DTS carts, phlebotomy carts, Mayo stands, ECG stands, sponge trolleys) built for durable, flexible clinical workflows.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            ...
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>COW laptop/desktop carts for mobile computing (LTS01/DTS01).</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Specialty carts: phlebotomy (PBS01), oxygen/nebulizer drawer (CBO2N1), ECG stand (C6000).</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Mayo stand and sponging trolley options for OR and wards.</span></li>
          </ul>
        </div>
      </section>
