        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div>
            ...
            <p className='text-lg md:text-xl text-gray-600 leading-relaxed mb-8'>
              Medical protective hood / head cover providing full head coverage. Non-woven, 45gsm, elastic facial band to keep dust and chemicals off hair and neck.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Non-woven hood cover; 45gsm; white; unisex.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Elastic around facial area for secure fit.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Provides head/neck coverage; disposable single-use.</span></li>
          </ul>
        </div>
      </section>
