...
function ShampooCapPage({ product }) {
  ...
  const description = `The Shampoo Cap is a convenient, waterless hair cleaning solution designed for patients who are unable to shower or bathe. This innovative cap contains pre-moistened cleaning solution that effectively cleans hair without requiring water, making it ideal for bedridden patients and long-term care settings.
...
The Shampoo Cap provides healthcare professionals and caregivers with a convenient, effective solution for maintaining patient hair hygiene, ensuring comfort and cleanliness for patients unable to shower.`
