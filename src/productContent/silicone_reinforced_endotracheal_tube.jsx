    ...
    <div className='bg-white text-black'>
      ...
      <section className='relative overflow-hidden'>
        <div className='absolute inset-0'>
          <img
            src={product.image}
            alt='Silicone Reinforced Endotracheal Tube'
        ...
        <div className='relative max-w-6xl mx-auto px-6 py-24 lg:py-32'>
          <div className='lg:w-2/3'>
            ...
            <h1 className='text-4xl lg:text-6xl font-extrabold mt-4 mb-6'>
              Silicone Reinforced Endotracheal Tube (Cuffed & Uncuffed)
            </h1>
          ...
          <div className='space-y-6'>
            <div className='flex gap-4'>
              ...
              <p className='text-lg text-black'>
                Steel reinforced tube can prevent biting & kinking.
              </p>
            </div>
            <div className='flex gap-4'>
              <div className='flex-shrink-0 w-2 h-2 mt-2 rounded-full bg-primary'></div>
              <p className='text-lg text-black'>
                High volume low pressure cuff reduces the pressure to tracheal wall.
              </p>
            </div>
            <div className='flex gap-4'>
              <div className='flex-shrink-0 w-2 h-2 mt-2 rounded-full bg-primary'></div>
        ...
        <div className='mt-16'>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-start mb-16'>
            <div className='rounded-2xl overflow-hidden shadow-xl'>
              <img
                src={product.image}
                alt='Silicone Reinforced Endotracheal Tube - Cuffed'
                className='w-full h-auto object-cover'
              />
            </div>
              ...
              <table className='w-full border-collapse'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT3524C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4024C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4524C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5024C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5524C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6024C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6524C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>7.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT7024C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>7.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT7524C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>8.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT8024C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>8.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT8524C</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>9.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT9024C</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>9.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT9524C</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className='mt-16'>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-start'>
            <div className='rounded-2xl overflow-hidden shadow-xl'>
              <img
                src={product.image}
                alt='Silicone Reinforced Endotracheal Tube - Uncuffed'
                className='w-full h-auto object-cover'
              />
            </div>
            <div className='overflow-x-auto'>
              <table className='w-full border-collapse'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT2524</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>3.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT3024</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>3.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT3524</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4024</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>4.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT4524</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5024</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>5.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT5524</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6024</td>
                  </tr>
                  <tr>
                    <td className='border border-gray-300 px-6 py-4 text-black'>6.5</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT6524</td>
                  </tr>
                  <tr className='bg-gray-50'>
                    <td className='border border-gray-300 px-6 py-4 text-black'>7.0</td>
                    <td className='border border-gray-300 px-6 py-4 text-black'>ETT7024</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className='bg-primary/10 border border-primary/30 rounded-3xl px-10 py-12 flex flex-col lg:flex-row items-center lg:items-start gap-8'>
          <div className='lg:w-2/3 space-y-4'>
            ...
            <p className='text-black'>
              Contact our specialists to discuss how Silicone Reinforced Endotracheal Tube can enhance your airway management protocols.
            </p>
          </div>
          <a 
            href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product.name} ($${product.price})`}
