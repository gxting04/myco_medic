        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[500px] bg-white p-8 flex items-center justify-center'>
             <img
              ...
              onError={(e) => {
                e.target.src = 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=80&w=1887&auto=format&fit=crop'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-xl text-gray-600 leading-relaxed mb-8'>
              A convenient, single-use shampoo cap that cleans, refreshes, moisturizes, and protects hair without the need for water. Microwaveable for added comfort.
            </p>
            ...
            <div>
              ...
              <ul className='space-y-4 text-gray-600'>
                <li className='flex items-center gap-3'>
                  ...
                  <span>Soft and comfortable material.</span>
                </li>
                <li className='flex items-center gap-3'>
                  <div className='w-2 h-2 rounded-full bg-primary shrink-0' />
                  <span>Microwave heating capable for warm application.</span>
                </li>
                <li className='flex items-center gap-3'>
                  <div className='w-2 h-2 rounded-full bg-primary shrink-0' />
                  <span>Cleans, refreshes, moisturizes, and protects hair.</span>
                </li>
                <li className='flex items-center gap-3'>
                  <div className='w-2 h-2 rounded-full bg-primary shrink-0' />
                  <span>Single-use for hygiene; contains 1 cap per pack.</span>
                </li>
              </ul>
            </div>
              ...
              <div className='space-y-4 text-gray-600 text-sm'>
                ...
                <div className='bg-gray-50 rounded-xl p-4 space-y-2'>
                  ...
                  <div className='grid grid-cols-[1fr,2fr] gap-2'>
                    ...
                    <span>Creates lather to remove dirt and oil.</span>
                    
                    <span className='font-medium'>Diazolidinyl Urea</span>
                    <span>Antimicrobial preservative.</span>
                    
                    <span className='font-medium'>Cocoamide DEA</span>
