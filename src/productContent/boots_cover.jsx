        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[420px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/c089384f2a198f62d43f78316cd83034-removebg-preview_orig.png'
              }}
            />
          </div>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Material: Non-woven + PE film, 60gsm.</span></li>
            ...
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Elastic ankle; one size fits all; unisex.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>1 unit = 1 pair; suitable for hospitals, labs, factories, disinfection work.</span></li>
          </ul>
        </div>
      </section>
