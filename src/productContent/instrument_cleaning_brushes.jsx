    ...
    <div className='bg-[#f5f5f7] min-h-screen'>
        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[500px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/untitled_6_orig.png'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-xl text-gray-600 leading-relaxed mb-8'>
              Instrument cleaning brushes available with stainless, nylon, double-ended, and double-tapered options for thorough device cleaning.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          <h2 className='text-3xl font-bold text-gray-900 mb-10'>Options</h2>
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Stainless bristles for tougher residue.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Nylon bristles for delicate surfaces.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Double-ended variants for versatility.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Double tapered designs to reach narrow lumens.</span></li>
          </ul>
        </div>
      </section>
