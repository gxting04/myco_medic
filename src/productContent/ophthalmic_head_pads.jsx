        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-6 text-black'>
              Ophthalmic Head Pads (1105 Series)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Dedicated supports for ophthalmic and maxillofacial procedures, designed to maintain comfortable,
              stable positioning in local anesthetic settings.
            </p>
            <div className='flex flex-wrap gap-4 mt-8'>
              <a
                href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product?.name ?? 'Ophthalmic Head Pads'}`}
          ...
          <div className='space-y-4 text-gray-700'>
            ...
            <div className='space-y-3'>
              <div className='flex items-start gap-3'>
                ...
                <p>Protect and support the head in ophthalmic and maxillofacial surgery.</p>
              </div>
              <div className='flex items-start gap-3'>
                <svg className='w-6 h-6 text-primary mt-1' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M5 13l4 4L19 7' />
                </svg>
                <p>Provide comfort for patients in a local anesthetic state.</p>
              </div>
            </div>
            ...
            <div className='mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg text-gray-800'>
              ...
              <p className='mb-2'>
                1105-1 and 1105-2 share the same shape in different sizes, while 1105-3 and 1105-4 offer
