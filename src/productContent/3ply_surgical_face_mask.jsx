        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[420px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/asp-medical-product-surgical-mask-orig-removebg-preview_orig.png'
              }}
            />
          </div>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Material: 3-ply non-woven / melt blown / non-woven (25+25+25gsm).</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Blue color; metal strip nose bar; latex-free earloops.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>BFE ≥98%; single-use; box of 50 pcs.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Applications: general healthcare and daily use.</span></li>
          </ul>
        </div>
      </section>
