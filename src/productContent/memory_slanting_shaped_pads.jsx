...
// https://www.mycomedic.com.my/memory-slanting-shaped-pads.html
const SIZE_OPTIONS = [
  {
    code: 'OKL-S01',
    label: 'OKL-S01 – 300 mm x 120 mm x 60 mm',
    sizeText: '300 mm x 120 mm x 60 mm'
  },
  {
    code: 'OKL-S03',
    label: 'OKL-S03 – 380 mm x 180 mm x 130 mm',
    sizeText: '380 mm x 180 mm x 130 mm'
  }
]
        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-4 text-black'>
              Memory Slanting Shaped Pads (OKL-S01 / OKL-S03)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Slanting shaped memory foam pads designed to fix and stabilise the body in supine and lateral surgeries,
              providing angled support that helps maintain positioning and reduce pressure.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className='max-w-6xl mx-auto px-6 py-16'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-start'>
          ...
          <div>
            <img
              src={product?.image}
              alt='Memory Slanting Shaped Pads'
            ...
            <div>
              ...
              <ul className='space-y-3 text-gray-700'>
                <li className='flex items-start gap-3'>
                  ...
                  <span>OKL-S01: To fix the body in supine surgeries with gentle slanting support.</span>
                </li>
                <li className='flex items-start gap-3'>
                  <svg className='w-6 h-6 text-primary mt-1' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                    <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M5 13l4 4L19 7' />
                  </svg>
                  <span>OKL-S03: To fix the body in lateral surgeries and help maintain a stable position.</span>
                </li>
              </ul>
            </div>
              ...
              <table className='w-full'>
                ...
                <tbody>
                  <tr className='bg-gray-50'>
                    <td className='px-6 py-4 font-medium text-gray-900'>OKL-S01</td>
                    <td className='px-6 py-4 text-gray-700'>300 mm x 120 mm x 60 mm</td>
                    <td className='px-6 py-4 text-gray-700'>
                      Slanting pad to fix and support the body in supine surgeries.
                    </td>
                  </tr>
                  <tr className='bg-white'>
                    <td className='px-6 py-4 font-medium text-gray-900'>OKL-S03</td>
                    <td className='px-6 py-4 text-gray-700'>380 mm x 180 mm x 130 mm</td>
                    <td className='px-6 py-4 text-gray-700'>
                      Larger slanting pad to fix the body during lateral surgeries and maintain stable positioning.
                    </td>
                  </tr>
                </tbody>
              </table>
