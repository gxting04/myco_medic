        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='relative rounded-3xl overflow-hidden shadow-lg aspect-square lg:aspect-auto lg:h-[520px] bg-white p-8 flex items-center justify-center'>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://www.mycomedic.com.my/uploads/9/7/1/1/9711883/editor/screenshot-969.png?1724999947'
              }}
            />
          </div>
          ...
          <div>
            ...
            <p className='text-xl text-gray-600 leading-relaxed mb-8'>
              Curve curtain tracking system for hospital cubicles, available in light, heavy, and extra-heavy duty options with compatible cubicle curtain fabric.
            </p>
      ...
      <section className='py-16 px-6 max-w-7xl mx-auto'>
        <div className='bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100'>
          ...
          <ul className='space-y-3 text-gray-600 leading-relaxed'>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Light, heavy, and extra-heavy duty track options.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Compatible cubicle curtain fabrics available.</span></li>
            <li className='flex gap-3'><span className='text-primary font-bold'>•</span><span>Supports curved layouts for flexible ward partitions.</span></li>
          </ul>
        </div>
      </section>
