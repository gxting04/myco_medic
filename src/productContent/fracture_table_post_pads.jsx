        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-6 text-black'>
              Fracture Table Post Pads (3105)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Pads for fracture table posts, designed to protect the perineal area by reducing compression and
              pressure-related injury risk.
            </p>
            <div className='flex flex-wrap gap-4 mt-8'>
              <a
                href={`https://wa.me/60196649622?text=Hi, I'm interested in ${product?.name ?? 'Fracture Table Post Pads'}`}
          ...
          <div className='space-y-4 text-gray-700'>
            ...
            <div className='space-y-3'>
              <div className='flex items-start gap-3'>
                ...
                <p>To avoid compression injury on the perineal area.</p>
              </div>
            </div>
            ...
            <div className='mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg text-gray-800'>
              ...
              <p>Available in different models and sizes for various fracture table post configurations.</p>
            </div>
          </div>
        </div>
      </section>
