        ...
        <div className='max-w-6xl mx-auto px-6 py-20 lg:py-28'>
          <div className='lg:w-3/4'>
            ...
            <h1 className='text-4xl lg:text-5xl font-extrabold mt-4 mb-6 text-black'>
              Flat Supine Head Pads (1106 Series)
            </h1>
            <p className='text-lg text-gray-700 leading-relaxed'>
              Flat pads that ease pressure on the head and keep patients comfortable in supine positioning,
              with accessory options for lumbar and lower-limb support in lateral procedures.
            </p>
            <div className='flex flex-wrap gap-4 mt-8'>
              <a
                href={`https://wa.me/60123822001?text=Hi, I'm interested in ${product?.name ?? 'Flat Supine Head Pads'}`}
          ...
          <div className='space-y-4 text-gray-700'>
            ...
            <div className='space-y-3'>
              <div className='flex items-start gap-3'>
                ...
                <p>Ease pressure on the head and maintain comfort in supine position.</p>
              </div>
              <div className='flex items-start gap-3'>
                <svg className='w-6 h-6 text-primary mt-1' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M5 13l4 4L19 7' />
                ...
                <p>
                  When used with an accessory stand, helps support and protect knees, waist and perinea in
                  lateral surgeries.
                </p>
              </div>
            </div>
