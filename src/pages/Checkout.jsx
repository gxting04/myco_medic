                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                  ...
                  <div className='space-y-4'>
                    ...
                    <button
                      ...
                      disabled={loading}
                      className='w-full bg-green-600 text-white px-6 py-4 rounded-lg hover:bg-green-700 transition-colors font-medium text-lg disabled:opacity-50 disabled:cursor-not-allowed'
                    >
                      {loading ? 'Processing...' : 'Demo Payment (For Testing)'}
                    </button>

                    <button
                      type='submit'
                      disabled={loading}
                      className='w-full bg-primary text-white px-6 py-4 rounded-lg hover:bg-primary/90 transition-colors font-medium text-lg disabled:opacity-50 disabled:cursor-not-allowed'
                    >
                      {loading ? 'Processing...' : 'Pay with Stripe (GrabPay / Card / FPX)'}
                    </button>
                  </div>
                </form>
              </div>
