            ...
            <form onSubmit={handleSearch} className='max-w-2xl mx-auto mb-6'>
              <div className='flex gap-4'>
                <input
                  ...
                  className='flex-1 px-6 py-4 border-2 border-gray-300 rounded-full focus:outline-none focus:border-primary text-lg shadow-sm'
                />
                <button
                  type='submit'
                  className='px-8 py-4 bg-primary text-white rounded-full hover:bg-primary/90 transition-colors font-medium flex items-center gap-2 shadow-lg hover:shadow-xl'
                >
