  ...
  return (
    <div className="bg-[#f5f5f7] min-h-screen">
      ...
      <div className="pt-32 pb-20 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto">
        ...
        {/* Locate Us Section - First */}
        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-6 text-gray-900">Locate Us</h2>
          <div className="w-full h-[400px] md:h-[500px] rounded-3xl overflow-hidden shadow-md border border-gray-200">
            <iframe
        ...
        {/* Office & Contacts Section - Second */}
        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-6 text-gray-900">Office & Contacts</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-600 leading-relaxed">
        ...
        <section className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold mb-8 text-gray-900 text-center">Send a Message</h2>
